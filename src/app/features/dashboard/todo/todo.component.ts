...
export class TodoComponent {
  ...
  checkIcon = viewChildren<ElementRef<HTMLButtonElement>>('checkIcon');
 ...
 //Seee task details =====================================>
  seeTaskDetails(id:any,event:Event){
    ...
    this.router.navigate(['taskdetails/',{id:id}]);
  }
...
closePopup(){
  this.#componentRef?.instance.close.subscribe(() => {
    this.checkIcon().forEach((check)=>{
      check.nativeElement.classList.remove('bx-checkbox-checked');
      check.nativeElement.classList.add('bx-checkbox');
    })
